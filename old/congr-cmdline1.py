...
def generate_file_metadata(dir_path, include_files=True, create_fingerprints=True):
    # Create a graph
    g = Graph()
    g.bind('gist', gist)
    g.bind('congr', congr)
...
def main():
    ...
    parser.add_argument('dir_path', type=str, help='Path to the starting directory')
    parser.add_argument('--files', dest='include_files', action='store_true', help='Include files in metadata (default: True)')
    ...
    parser.add_argument('--fingerprints', dest='create_fingerprints', action='store_true', help='Create file fingerprints (default: True)')
    ...
    generate_file_metadata(args.dir_path, include_files=args.include_files, create_fingerprints=args.create_fingerprints)
