...
def generate_file_metadata(dir_path, create_fingerprints=True, include_files=True):
    # Create a graph
    g = Graph()
    g.bind('gist', gist)
    g.bind('congr', congr)
...
# Example usage:
generate_file_metadata('C:\\Users\\StevenChalem\\congr-test', create_fingerprints=False, include_files=False)
