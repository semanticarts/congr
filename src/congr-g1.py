...
iana = Namespace("https://www.w3.org/ns/iana/media-types/")
    ...
    for root, dirs, files in os.walk(dir_path):
        ...
        for filename in files:
            ...
            if os.path.isfile(file_path):
                ...
                if mime_type:
                    # Create IANA media type node
                    iana_media_type_node = URIRef(iana + mime_type.replace('/', '/') + "#Resource")
                    g.add((file_node, RDF.type, iana_media_type_node))
