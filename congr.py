...
SPACETIME_HASH_TRUNC_LENGTH = 10 # Length of the hash for file location and date/time
CONTENT_HASH_CHUNK_SIZE = 4096 # Size of the chunks to read from files for content hashing
